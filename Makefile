...
vendor_saved_apps := Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
		     ...
		     CaptivePortalLogin ConfigPanel SuperSU com.qualcomm.location \
		     SettingsProvider NfcNci CMSettingsProvider zhiyou tudou BluetoothExt \
...
override_property += \
    ro.flyme.romer=tudou \
    ro.product.model_romer=A0001_tudou \
